...
View::renderComponent(
    'Header',
    [
        'page_title' => SITE_NAME . ' | product',

        'stylesheets' => ['studyMaterialDetail'],
        'scripts' => ['script', 'parseTimeAgo', 'jquery.min', 'studyMaterialDetail'],
    ]
);
View::renderComponent('SideNav');
?>
<main class="container">
    ...
    <section>
        ...
        <div class="background-thumbnail" style="background-image: url('/<?= $studyMaterial['thumbnail_path'] ?>')">
            ...
            <div class="postDetails-thumbnail-wrapper">
                ...
                <div class="postDetails">
                    ...
                    <div class="time">
                        <p>
                            <span class="time-ago" data-datetime="<?= $studyMaterial['created_at'] ?>"></span>
                        </p>
                ...
                <div class="thumbnail rounded-3xl">
                    <img src="/<?= $studyMaterial['thumbnail_path'] ?>" alt="thumbnail">
                    ...
                    <div>
                        ...
                        <div class="document-type">
                            <?php if ($studyMaterial['format'] == 'handwritten'): ?>
                                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <?php else: ?>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M20 1C21.6569 1 23 2.34315 23 4V8C23 8.55228 22.5523 9 22 9C21.4477 9 21 8.55228 21 8V4C21 3.44772 20.5523 3 20 3H16C15.4477 3 15 2.55228 15 2C15 1.44772 15.4477 1 16 1H20Z"
                                        fill="#0F0F0F" />
                                    <path
                                        d="M22 15C22.5523 15 23 15.4477 23 16V20C23 21.6569 21.6569 23 20 23H16C15.4477 23 15 22.5523 15 22C15 21.4477 15.4477 21 16 21H20C20.5523 21 21 20.5523 21 20V16C21 15.4477 21.4477 15 22 15Z"
                                        fill="#0F0F0F" />
                                    <path
                                        ...
                                        fill="#0F0F0F" />
                                    <path
                                        d="M2 9C1.44772 9 1 8.55228 1 8V4C1 2.34315 2.34315 1 4 1H8C8.55228 1 9 1.44772 9 2C9 2.55228 8.55228 3 8 3H4C3.44772 3 3 3.44772 3 4V8C3 8.55228 2.55228 9 2 9Z"
                                        fill="#0F0F0F" />
        ...
        <div class="education-level">
            <span class="document-type">
                Document-Type :
                <?= $studyMaterial['document_type'] ?>
            </span>
            <span class="format">
                Format :
                <?= $studyMaterial['format'] ?>
            </span>
            <span>#
                <?= $studyMaterial['education_level'] ?>
            </span>
            <span>#
                <?= $studyMaterial['semester'] ?: 'N/A' ?>
            </span>
        ...
        <div class="meta-data-section">
            ...
            <div class="meta-data">
                <span>
                    <svg viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                            <path d="M287.432 300.302C306.779 385.028 292.971 360.599 250.743 326.789"
                            ...
                            <path
                                ...
                                stroke="currentColor" stroke-opacity="0.9" stroke-width="16" stroke-linecap="round"
                                stroke-linejoin="round"></path>
                            <path d="M202.342 217.653C191.302 226.163 177.423 229.779 167.993 217.653"
                                stroke="currentColor" stroke-opacity="0.9" stroke-width="16" stroke-linecap="round"
                                stroke-linejoin="round"></path>
                            <path d="M172.991 181.787C173.526 177.726 173.734 173.411 173.926 169.312"
                                stroke="currentColor" stroke-opacity="0.9" stroke-width="16" stroke-linecap="round"
                                stroke-linejoin="round"></path>
                            <path d="M205.545 181.787C206.547 177.575 206.945 173.572 206.945 169.312"
                                stroke="currentColor" stroke-opacity="0.9" stroke-width="16" stroke-linecap="round"
                                stroke-linejoin="round"></path>
                            <path d="M292.896 217.653C272.658 257.951 236.129 288.872 216.393 328.371"
                                stroke="currentColor" stroke-opacity="0.9" stroke-width="16" stroke-linecap="round"
                                stroke-linejoin="round"></path>
                            <path d="M307.729 214.535C328.431 219.263 318.55 236.092 302.265 227.927"
                                stroke="currentColor" stroke-opacity="0.9" stroke-width="16" stroke-linecap="round"
                                stroke-linejoin="round"></path>
                            ...
                            <path d="M261.425 169.128C280.874 167.251 266.987 186.589 257.165 192.391"
                                stroke="currentColor" stroke-opacity="0.9" stroke-width="16" stroke-linecap="round"
                                stroke-linejoin="round"></path>
                        </g>
                    </svg>
            ...
            <div class="intercation">
                ...
                <!-- likes -->
                <button class="like <?= $studyMaterial['like_status'] ? 'active' : '' ?>" id="like-button"
                    onclick="likeStudyMaterial(<?= $studyMaterial['id'] ?>)">
        ...
        <div class="pdf-section">
            <iframe src="/<?= $studyMaterial['file_path'] ?>" style="width: 100%; height: 100%;"></iframe>
