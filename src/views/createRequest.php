        ...
        <div class="form-section">
            ...
            <form action="/requests/store" method="post">
                ...
                <div class="description col-span-full">
                    ...
                    <textarea required id="description" name="description" rows="3"></textarea>
                ...
                <div class="document_type">
                        <label for="document_type">I need ..</label>
                        <select name="document_type" id="document_type" required value="<?php echo isset($_SESSION['old']['document_type']) ? $_SESSION['old']['document_type'] : ''; ?>">
                ...
                <div class="class_faculty">
                    <label for="class_faculty">Class/ Faculty ( current )</label>
