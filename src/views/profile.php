<?php
req_once('src/views/components/Header.php', ['page_title' => 'Profile - '.SITE_NAME, 'stylesheets' => ['profile'], 'scripts' => ['script', 'toast', 'threeDotMenu', 'sideInfo', 'searchOverlay']]);
req_once('src/views/components/SideNav.php',['current_page' => 'profile']);
?>


    <main class="container">
        <?php req_once('src/views/components/MenuHeader.php', ['current_page' => 'profile']); ?>
                ...
                <div class="card ">
                    ...
                    <a href="productPage.html" class="intercation">
                        ...
                        <div class="view">
                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="userround" stroke-linejoin="round" stroke-width="2"
                                    d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z">
                                </path>
...
req_once('src/views/components/ThreeDotMenu.php');
req_once('src/views/components/SideInfo.php');
