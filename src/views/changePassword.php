        ...
        <div class="form-section">
                ...
                <form action="/profile/edit/password" method="post" ?>
                    ...
                    <div class="oldPassword">
                        <label for="oldPassword">Old
                            Password</label>
                        <input type="password" placeholder="••••••••" required name="password" id="oldPassword" />
                    </div>
                    <!-- new password -->
                    <div class="newPassword sm:row-start-2">
                        <label for="new_password">New
                            Password</label>
                        <input type="password" placeholder="••••••••" required name="new_password" id="newPassword" />
                    </div>
                    <!-- confirm password -->
                    <div class="confirmPassword sm:row-start-3">
                        https://rayyan-balami.github.io/notes/public/accountSecurity.html
            ...
            <div>
                ...
                <form action="/profile/edit/private" method="post" >
                    ...
                    <!-- private account -->
                    <div class="privateAccount col-span-full">
                        <input type="checkbox" id="privateAccount" name="private" 
                            <?php if ($user['private']) echo 'checked' ?> />
                        <label for="privateAccount">Private Account
                            <p>
                                Only you can see your profile and materials.
                            </p>
                        </label>
                    </div>
