        ...
        <div>
            ...
            <form method="post" action="/login">
                ...
                <div class="email">
                    ...
                    <input type="text" placeholder="WizDemy@gmail.com"  name="email_username" id="email_username"value="<?php echo isset($_SESSION['old']['email_username']) ? htmlspecialchars($_SESSION['old']['email_username']) : '' ?>" required />
