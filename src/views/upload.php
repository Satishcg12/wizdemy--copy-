<?php
View::renderComponent('Header',['page_title' => 'Upload - '.SITE_NAME,'stylesheets' => ['upload'],'scripts' => ['toast','threeDotMenu','sideInfo','searchOverlay','previewUpload']]);
    ...
    <main class="container">
        ...
        <section>
            ...
            <div class="form-section">
                ...
                <!-- form -->
                <form action="src/php/actions.php?uploadStudyMaterial" class="search-form" id="uploadForm" method="POST" enctype="multipart/form-data">
