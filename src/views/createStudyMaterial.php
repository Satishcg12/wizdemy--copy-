...
<main class="container">
    ...
    <section>
        ...
        <div class="form-section">
            ...
            <!-- form -->
            <form action="/studymaterial/store" class="search-form" id="uploadForm" method="POST"
                enctype="multipart/form-data">

                <!-- responding to if comming from respond button -->

                <?php if (isset($requestDetail)): ?>
                    <input type="hidden" name="request_id" value="<?= htmlspecialchars($requestDetail['id']) ?>">
                    <div class="responding-to">
                        <div>Responding to</div>
                        <p>
                            <?= htmlspecialchars($requestDetail['full_name']) ?> &mdash;
                            <?= htmlspecialchars($requestDetail['title']) ?>
                        </p>
                    </div>
                <?php endif; ?>
                <!-- title (required)-->
                <div class="title">
                    ...
                    <input type="text" placeholder="functions in C programming language." required name="title"
                        id="title"
                        value="<?php echo isset($_SESSION['old']['title']) ? $_SESSION['old']['title'] : ''; ?>" />
                </div>
                ...
                <div class="description col-span-full">
                    ...
                    <textarea required id="description" name="description"
                        rows="3"><?php echo isset($_SESSION['old']['description']) ? $_SESSION['old']['description'] : ''; ?></textarea>
                ...
                <div class="document_type">
                    ...
                    <?php if (isset($requestDetail)): ?>
                        <input type="text" value="<?= htmlspecialchars($requestDetail['document_type']) ?>" disabled
                            name="document_type" id="document_type">
                    <?php else: ?>
                        <select name="document_type" id="document_type" required
                            value="<?php echo isset($_SESSION['old']['document_type']) ? $_SESSION['old']['document_type'] : ''; ?>">
                            <option value="" disabled selected>Select an option...</option>
                            <option value="note" name="document_type">Note</option>
                            <option value="question" name="document_type">Question</option>
                            <option value="lab report" name="document_type">Lab Report</option>
                        </select>
                ...
                <div class="education_level">
                    ...
                    <?php if (isset($requestDetail)): ?>
                        <input type="text" value="<?= htmlspecialchars($requestDetail['education_level']) ?>" disabled
                            name="education_level" id="education_level">
                    <?php else: ?>
                        <select name="education_level" id="education_level" required
                            value="<?php echo isset($_SESSION['old']['education_level']) ? $_SESSION['old']['education_level'] : ''; ?>">
                            <option value="" disabled selected>Select an option...</option>
                            <option value="School" name="education_level">School</option>
                            <option value="+2" name="education_level">+2</option>
                            <option value="Bachelor" name="education_level">Bachelor</option>
                            <option value="Master" name="education_level">Master</option>
                            <option value="PhD" name="education_level">PhD</option>
                        </select>
                        <svg class="caret-up-down" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                ...
                <div class="semester">
                    ...
                    <?php else: ?>
                        <select name="semester" id="semester"
                            value="<?php echo isset($_SESSION['old']['semester']) ? $_SESSION['old']['semester'] : ''; ?>">
                            <option value="" disabled selected>Select an option...</option>
                ...
                <div class="subject">
                    ...
                    <?php if (isset($requestDetail)): ?>
                        <input type="text" value="<?= htmlspecialchars($requestDetail['subject']) ?>" disabled
                            name="subject" id="subject">
                    <?php else: ?>
                        <input type="text" placeholder="C Programming" required name="subject" id="subject"
                            value="<?php echo isset($_SESSION['old']['subject']) ? $_SESSION['old']['subject'] : ''; ?>" />
                    <?php endif; ?>
                </div>
                ...
                <div class="class">
                    ...
                    <?php if (isset($requestDetail)): ?>
                        <input type="text" value="<?= htmlspecialchars($requestDetail['class_faculty']) ?>" disabled
                            name="class_faculty" id="class_faculty">
                    <?php else: ?>
                        <input type="text" placeholder="Class 10, Management, Science, BCA, BCSIT, MCA etc" required
                            name="class_faculty" id="class_faculty"
                            value="<?php echo isset($_SESSION['old']['class']) ? $_SESSION['old']['class'] : ''; ?>" />
                    <?php endif; ?>
                </div>
                ...
                <div class="author">
                    ...
                    <input type="text" placeholder="Rayyan Balami" required name="author" id="author"
                        value="<?php echo isset($_SESSION['old']['author']) ? $_SESSION['old']['author'] : ''; ?>" />
                </div>
                ...
                <div class="file-thumbnail">
                    ...
                    <input id="file-thumbnail" name="file-thumbnail" type="file" accept=".jpg,.jpeg,.png" required hidden size="10MB" />
                </div>
                ...
                <div class="file-document">
                    ...
                    <input id="file-document" name="file-document" type="file" accept=".pdf" required hidden />
                    <p>
            ...
            <!-- dialog for uploading progressbar -->
            <div class="uploading-dialog" id="uploading-dialog">
                <div>
